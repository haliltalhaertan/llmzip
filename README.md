...
research lines (including sealed Task 4F1) are unaffected.
Open questions across all lines, each traced to where it is recorded as open:
[`OPEN_QUESTIONS_2026-09-18.md`](OPEN_QUESTIONS_2026-09-18.md). Read [`TWELVE_BYTE_PILOT_README.md`](TWELVE_BYTE_PILOT_README.md) before opening
