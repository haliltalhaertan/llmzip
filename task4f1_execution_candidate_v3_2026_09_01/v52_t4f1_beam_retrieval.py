...
AUTH_SCHEMA = "V52_T4F1_RUN_AUTHORIZATION_V3"
AUTH_SIGNED_FIELDS = (
    "schema",
    "status",
...
def verify_execution_seal(path: Path, script_path: Path) -> tuple[dict[str, Any], str]:
    ...
    if seal.get("schema") != "V52_T4F1_EXECUTION_CANDIDATE_SEAL_V3":
...
def verify_existing_archive(
    ...
    if (
        metadata.get("schema") != "V52_T4F1_ARCHIVE_RESULT_META_V3"
...
def finalize_results(
    ...
    manifest = {
        "schema": "V52_T4F1_POST_RUN_MANIFEST_V3",
        "task": TASK,
...
def preflight(args: argparse.Namespace, script_path: Path) -> None:
    ...
    report = {
        "schema": "V52_T4F1_IMPLEMENTATION_PREFLIGHT_V3",
        "status": "PASS",
