#!/usr/bin/env python3
"""Build the V52 Task 4F1 scientific preregistration Seal V2 by DERIVING every value from bytes.

Seal V1 carried hand-transcribed tier labels and shipped them wrong. Nothing here is transcribed:
cohort structure is recomputed from the sealed CSV, and the binding-7/8 source text is extracted
from the approved draft. This script writes the seal; tools/verify_preregistration_seal.py
re-derives the same facts independently and is what must pass.
...
OUT = ROOT / "docs/v52/task4f1/TASK4F1_PREREGISTRATION_SEAL_V2_2026-09-04.json"
...
def main() -> int:
    ...
    seal = OrderedDict([
        ("schema", "V52_T4F1_SCIENTIFIC_PREREGISTRATION_SEAL_V2"),
        ("seal_id", "V52_TASK_4F1_SCIENTIFIC_PREREGISTRATION_SEAL_V2_2026-09-04"),
        ("sealed_at_utc", "2026-09-04T10:40:00Z"),
        ("sealed_by", "Continuity Lead, under Head Researcher sealing direction 2026-09-04 and "
                      "Head Researcher Seal V1 defect decision 2026-09-04"),
        ...
        ("supersedes", OrderedDict([
            ...
            ("status_of_superseded_seal", "BLOCKED AS A SEAL ARTIFACT; preserved byte-unchanged as a "
                                          "historical defective artifact and never edited"),
            ("why", "Seal V1 binding 2 carried hand-transcribed tier labels 100K/1M/5M/10M: the 500K tier "
                    "was missing, a 5M tier that exists nowhere in the cohort or the draft was introduced, "
                    "and the 500K and 1M counts were shifted onto the wrong labels. Its verifier checked "
                    "binding 2 only by the cohort file digest, binding 7 only by list length and binding 8 "
                    "only for a non-empty string, so its PASS did not test the defect."),
            ("defect_decision", OrderedDict([
                ("branch", "hr/prereg-seal-v1-defect-2026-09-04"),
                ("commit", "c867ea123a3ee7fba19a78ca59312601aac9fbc4"),
                ("path", "docs/v52/task4f1/T4F1_PREREG_SEAL_V1_DEFECT_DECISION_2026-09-04.md"),
                ("sha256", sha256_blob("c867ea123a3ee7fba19a78ca59312601aac9fbc4",
        ...
        ("bindings", OrderedDict([
            ...
            ("8_exact_rational_sign_classification_condition", OrderedDict([
                ...
                ("condition", "Before any run authorization, the outcome-analysis implementation must honour the "
                              "preregistered exact-rational sign rule for D_t rather than classify the sign from a "
                              "rounded or floating-point aggregate."),
                ...
                ("origin_artifact", OrderedDict([
                    ...
                    ("sha256", approvals["4_head_researcher_rereview_decision"]["sha256"])])),
